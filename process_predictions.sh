...
for exp in {mlp_split_objects_relative-joints,pointnet_split_objects_relative-joints,mlp_split_participants_relative-joints,pointnet_split_participants_relative-joints}; do
