...
$ python eval.py --show_object \
    ...
    --checkpoint data/checkpoints/pointnet_split_objects_skeleton/checkpoint_model_145_train_loss=1.359683.pth
```
...
$ ./eval_script.sh configs/pointnet.ini objects \
    data/checkpoints/pointnet_split_objects_skeleton/checkpoint_model_145_train_loss=1.359683.pth 0
```
