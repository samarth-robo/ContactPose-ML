...
Hand-object contact modeling with **simple-joints** features. Implemented
...
$ python eval.py --show_object \
    ...
    --checkpoint data/checkpoints/pointnet_split_objects_simple-joints/checkpoint_model_136_train_loss=1.626144.pth
```
...
$ ./eval_script.sh configs/pointnet.ini objects \
    data/checkpoints/pointnet_split_objects_simple-joints/checkpoint_model_136_train_loss=1.626144.pth 0
```
...
pre-processed data used in our experiments in `data/simple-joints_prediction_data`.